...
- Image quality: pages are sent at the size your screen shows them (or full size, your choice), downscaled on the server with a choice of filter to keep screentones clean. **Enhance** sharpens small pages on your device's graphics chip with the Anime4K line-art upscaler, in paged and vertical mode, with an **Efficient** or **Max quality** setting.
